...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference("Manager.count") do
      post managers_url, params: { manager: { managed_id: @manager.managed_id, manager_id: @manager.manager_id } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { managed_id: @manager.managed_id, manager_id: @manager.manager_id } }
